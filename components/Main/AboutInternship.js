...
const AboutInternship = () => {
  return (
    <div className="max-h-screen min-h-screen w-full grid place-items-center py-4 lg:pt-4 lg:py-20 px-12 md:px-36 lg:px-28 relative">
      <div className="w-full h-screen lg:h-3/5 grid gap-x-16 grid-rows-2 grid-cols-1 lg:grid-cols-2 lg:grid-rows-1 lg:items-end">
        ...
        <div className="grid place-items-center lg:block relative h-full lg:col-start-1">
          ...
          >
            ...
            ></div>
            <div className="absolute left-0 -bottom-8 transform translate-y-full">
              <h2 className="font-semibold text-lg md:text-2xl lg:text-4xl">
                ผศ.สุคนธ์ อักษรชู
              </h2>
              <h5 className="md:text-xl lg:text-2xl">
