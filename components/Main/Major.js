  ...
  return (
    ...
    >
      ...
      >
        <motion.h1
          layout
          className={`uppercase inline-block text-white font-extrabold pointer-events-none ${
            selected !== "mt"
        ...
        >
          {layoutSelectedIT !== "mt" && (
            <motion.div
              ...
              className="inset-0 absolute grid place-items-center"
            >
              <Scene className="square" selected={selected} id="it" />
            </motion.div>
          )}
        </motion.div>
      </motion.section>
      ...
      <div
        className={`majorDetails my-4 lg:my-8 ${
          selected ? "h-auto md:h-auto" : "hidden"
      ...
      >
        {selected === "it" && (
          <p className="h-auto text-sm sm:text-base md:text-lg lg:text-xl text-center md:text-left align-middle">
            ...
            เพื่อให้ผู้เรียนมีความรู้และทักษะเกี่ยวกับคณิตศาสตร์ ภาษาต่างประเทศ
            เทคโนโลยี เครือข่าย หุ่นยนต์ การเขียนโปรแกรม กราฟิก
            ...
            ได้แก่ การออกแบบและพัฒนาเว็บไซต์ ด้านการเขียนโปรแกรมและพัฒนาหุ่นยนต์
          </p>
        )}
        {selected === "mt" && (
          <p className="h-auto text-sm sm:text-base md:text-lg lg:text-xl text-center md:text-left align-middle">
      ...
      >
        ...
        <motion.div
          ...
          className=" inset-0 absolute grid place-items-center"
        >
          {(layoutSelectedMT !== "it" || selected === "mt") && (
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1, transition: { delay: 0.5 } }}
              className="inset-0 absolute grid place-items-center"
            >
              <Scene className="square" selected={selected} id="mt" />
            </motion.div>
          )}
        </motion.div>
      </motion.section>
